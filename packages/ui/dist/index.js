...
__export(index_exports, {
  ...
  setupZodRuLocale: () => setupZodRuLocale,
  useFormField: () => useFormField,
  zodRuLocale: () => zodRuLocale
});
...
var zodRuLocale = (issue, ctx) => {
  switch (issue.code) {
    ...
    case import_zod.z.ZodIssueCode.too_big:
      ...
      return { message: "\u041D\u0435\u0434\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435" };
    case import_zod.z.ZodIssueCode.custom:
      return { message: issue.message || "\u041D\u0435\u0434\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435" };
    case import_zod.z.ZodIssueCode.invalid_intersection_types:
      return { message: "\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u043F\u0435\u0440\u0435\u0441\u0435\u0447\u0435\u043D\u0438\u044F \u043D\u0435 \u043C\u043E\u0433\u0443\u0442 \u0431\u044B\u0442\u044C \u043E\u0431\u044A\u0435\u0434\u0438\u043D\u0435\u043D\u044B" };
    case import_zod.z.ZodIssueCode.not_multiple_of:
      return { message: `\u0427\u0438\u0441\u043B\u043E \u0434\u043E\u043B\u0436\u043D\u043E \u0431\u044B\u0442\u044C \u043A\u0440\u0430\u0442\u043D\u043E ${issue.multipleOf}` };
    case import_zod.z.ZodIssueCode.not_finite:
...
var setupZodRuLocale = () => {
  import_zod.z.setErrorMap(zodRuLocale);
};
...
function ZodForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_hook_form.FormProvider, { ...form, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "form",
    {
      ...
      style,
      ...formProps,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: contentClassName, children })
    }
  ) });
}
...
var useFormField = (name) => {
  ...
  const { errors, dirtyFields, touchedFields } = (0, import_react_hook_form2.useFormState)({ control });
...
function BaseFieldComponent({
  ...
  const fieldState = (0, import_react.useMemo)(() => ({
    error,
    isDirty,
    isTouched,
    isValid
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: fieldClassName, style, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: labelClassName, children: [
      label,
      required && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `azb-field-label-required ${classes?.labelRequired || ""}`, children: "*" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: classes?.input, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: errorClassName, children: error?.message || "" })
  ] });
}
var BaseField = (0, import_react.memo)(BaseFieldComponent);
...
function TextFieldComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    BaseField,
    {
      ...
      style,
      classes,
      children: (field, { error }) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        import_antd.Input,
        {
          ...field,
          placeholder,
...
var TextField = (0, import_react2.memo)(TextFieldComponent);
...
function PasswordField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    BaseField_default,
    {
      ...
      className,
      style,
      children: (field, error) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
...
function TextAreaField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    BaseField_default,
    {
      ...
      className,
      style,
      children: (field, error) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        TextArea,
        {
          ...field,
          placeholder,
...
function NumberField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    BaseField_default,
    {
      ...
      className,
      style,
      children: (field, error) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
...
function SelectField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    BaseField_default,
    {
      ...
      className,
      style,
      children: (field, error) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        import_antd5.Select,
        {
          ...field,
          placeholder,
...
function RadioField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    BaseField_default,
    {
      ...
      className,
      style,
      children: (field, error) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
        import_antd6.Radio.Group,
        {
          ...field,
          size,
          disabled,
          children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_antd6.Space, { direction, children: options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            import_antd6.Radio,
            {
              value: option.value,
...
function CheckboxField({
  ...
  const { errors } = (0, import_react_hook_form4.useFormState)({ control });
  const error = errors[name];
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className, style, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      import_react_hook_form4.Controller,
      {
        name,
        control,
        render: ({ field: { value, onChange, ...field } }) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
...
var import_ru_RU = __toESM(require("antd/locale/ru_RU"));
var import_ru = require("dayjs/locale/ru");
var import_jsx_runtime10 = require("react/jsx-runtime");
import_dayjs.default.locale("ru");
function DateFieldComponent({
  ...
  const handleDateChange = (0, import_react3.useCallback)((date, field) => {
    field.onChange(date ? date.toDate() : null);
  }, []);
  const formatString = showTime ? `${format} HH:mm:ss` : format;
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_antd8.ConfigProvider, { locale: import_ru_RU.default, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    BaseField,
    {
      name,
      label,
      ...
      className,
      style,
      children: (field, { error }) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        import_antd8.DatePicker,
        {
          ...field,
          value: field.value ? (0, import_dayjs.default)(field.value) : null,
...
var DateField = (0, import_react3.memo)(DateFieldComponent);
